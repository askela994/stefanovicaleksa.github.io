...
(() => {
  ...
  var Li = s(() => {
    window.tram = (function (e) {
      ...
      function h(l) {
        for (var p = -1, _ = l ? l.length : 0, m = []; ++p < _; ) {
          var g = l[p];
          g && m.push(g);
        }
        return m;
      ...
      var v = (function (l, p, _) {
          ...
          function z(re, he) {
            function W() {
              var Le = new se();
              return g(Le.init) && Le.init.apply(Le, arguments), Le;
            }
            function se() {}
            he === _ && ((he = re), (re = Object)), (W.Bare = se);
            var le,
              be = (O[l] = re[l]),
              rt = (se[l] = W[l] = new O());
            return (
              ...
              (W.open = function (Le) {
                if (
                  ((le = {}),
                  g(Le) ? (le = Le.call(W, rt, be, W, re)) : m(Le) && (le = Le),
                  m(le))
                )
                  for (var Tr in le) p.call(le, Tr) && (rt[Tr] = le[Tr]);
                return g(rt.init) || (rt.init = re), W;
              }),
              W.open(he)
            );
          }
        ...
        E = {
          ease: [
            ...
            function (l, p, _, m) {
              ...
              return (
                p +
                _ * (-2.75 * O * g + 11 * g * g + -15.5 * O + 8 * g + 0.25 * l)
              );
            },
          ],
          'ease-in': [
            ...
            function (l, p, _, m) {
              var g = (l /= m) * l,
                O = g * l;
              return p + _ * (-1 * O * g + 3 * g * g + -3 * O + 2 * g);
            },
          ],
          'ease-out': [
            'ease-out',
            function (l, p, _, m) {
              ...
              return (
                p +
                _ * (0.3 * O * g + -1.6 * g * g + 2.2 * O + -1.8 * g + 1.9 * l)
              );
            },
          ],
          'ease-in-out': [
            ...
            function (l, p, _, m) {
              var g = (l /= m) * l,
                O = g * l;
              return p + _ * (2 * O * g + -5 * g * g + 2 * O + 2 * g);
            },
          ],
          linear: [
            'linear',
          ...
          'ease-in-quart': [
            ...
            function (l, p, _, m) {
              return _ * (l /= m) * l * l * l + p;
            },
          ],
          'ease-out-quart': [
            'cubic-bezier(0.165, 0.840, 0.440, 1)',
            function (l, p, _, m) {
              return -_ * ((l = l / m - 1) * l * l * l - 1) + p;
            },
          ],
          'ease-in-out-quart': [
          ...
          'ease-in-quint': [
            ...
            function (l, p, _, m) {
              return _ * (l /= m) * l * l * l * l + p;
            },
          ],
          'ease-out-quint': [
            'cubic-bezier(0.230, 1, 0.320, 1)',
            function (l, p, _, m) {
              return _ * ((l = l / m - 1) * l * l * l * l + 1) + p;
            },
          ],
          'ease-in-out-quint': [
          ...
          'ease-in-sine': [
            ...
            function (l, p, _, m) {
              return -_ * Math.cos((l / m) * (Math.PI / 2)) + _ + p;
            },
          ],
          'ease-out-sine': [
            'cubic-bezier(0.390, 0.575, 0.565, 1)',
            function (l, p, _, m) {
              return _ * Math.sin((l / m) * (Math.PI / 2)) + p;
            },
          ],
          'ease-in-out-sine': [
            'cubic-bezier(0.445, 0.050, 0.550, 0.950)',
            function (l, p, _, m) {
              return (-_ / 2) * (Math.cos((Math.PI * l) / m) - 1) + p;
            },
          ],
          'ease-in-expo': [
            'cubic-bezier(0.950, 0.050, 0.795, 0.035)',
            function (l, p, _, m) {
              return l === 0 ? p : _ * Math.pow(2, 10 * (l / m - 1)) + p;
            },
          ],
          'ease-out-expo': [
          ...
          'ease-in-circ': [
            ...
            function (l, p, _, m) {
              return -_ * (Math.sqrt(1 - (l /= m) * l) - 1) + p;
            },
          ],
          'ease-out-circ': [
            'cubic-bezier(0.075, 0.820, 0.165, 1)',
            function (l, p, _, m) {
              return _ * Math.sqrt(1 - (l = l / m - 1) * l) + p;
            },
          ],
          'ease-in-out-circ': [
        ...
        M = function (l) {
          ...
          for (p = 0; p < g.length; p++)
            m += g[p].charAt(0).toUpperCase() + g[p].slice(1);
          for (p = 0; p < I.length; p++)
            if (((_ = I[p] + m), _ in D.style))
              return { dom: _, css: x[p] + l };
        },
        G = (t.support = {
      ...
      if (G.transition) {
        var $ = G.timing.dom;
        if (((D.style[$] = E['ease-in-back'][0]), !D.style[$]))
          for (var te in y) E[te][0] = y[te];
      }
      var q = (t.frame = (function () {
        ...
        j = v(function (l) {
            ...
            if (Z) {
              ...
              if (pe == 'object') {
                ...
                rt.call(
                  ...
                  Z,
                  function (Se, wI) {
                    Se.span > De && (De = Se.span), Se.stop(), Se.animate(wI);
                  },
                  function (Se) {
          ...
          function re(Z) {
            z.call(this, Z), rt.call(this, Z, Tr, SI);
          }
          function he(Z) {
        ...
        U = v(j, function (l) {
          function p(_, m) {
            var g = e.data(_, C) || e.data(_, C, new j.Bare());
            return g.el || g.init(_), m ? g.start(m) : g;
          }
          l.init = function (_, m) {
            var g = e(_);
            if (!g.length) return this;
            if (g.length === 1) return p(g[0], m);
            var O = [];
            return (
              g.each(function (z, re) {
                O.push(p(re, m));
              }),
              (this.children = O),
              this
        ...
        F = v(function (l) {
          ...
          function _(O, z, re) {
            return z !== void 0 && (re = z), O in E ? O : re;
          }
          function m(O) {
          ...
          (l.init = function (O, z, re, he) {
            ...
            re[2] && (W = re[2]),
              ...
              (this.ease = _(z[2], this.ease, g.ease)),
              ...
              de.fallback || he.fallback
                ...
                : ((this.animate = this.transition),
                  (this.string =
                    ...
                    this.duration +
                    'ms' +
                    (this.ease != 'ease' ? ee + E[this.ease][0] : '') +
          ...
          (l.init = function () {
            ...
            (l.values = function (m) {
              var g,
                O = {};
              return (
                _.call(this, m, function (z, re, he) {
                  (O[z] = re),
                    this.current[z] === void 0 &&
                      ((g = 0),
                      ~z.indexOf('scale') && (g = 1),
                      (this.current[z] = this.convert(g, he)));
                }),
                O
              );
            });
        ...
        J = v(function (l) {
          ...
          (l.init = function (W) {
            ...
            (l.play = function () {
              this.active ||
                (this.start || (this.start = H()), (this.active = !0), p(this));
            }),
            (l.stop = function () {
            ...
            (l.format = function (W, se) {
              ...
              if (!this.unit) {
                var le = se.replace(A, ''),
                  be = W.replace(A, '');
                le !== be && u('tween', se, W), (this.unit = le);
              }
              (se = parseFloat(se)),
                (W = parseFloat(W)),
          ...
          (l.init = function (_) {
            ...
            (l.render = function (_) {
              ...
              for (m = O; m--; )
                (g = this.tweens[m]),
                  g.context &&
                    (g.render(_), (this.current[g.name] = g.value), (z = !0));
              return z
      ...
      (t.fallback = function (l) {
        if (!G.transition) return (de.fallback = !0);
        de.agentTests.push('(' + l + ')');
        var p = new RegExp(de.agentTests.join('|'), 'i');
        de.fallback = p.test(navigator.userAgent);
      }),
        ...
        (t.delay = function (l, p, _) {
          return new Ee({ complete: p, duration: l, context: _ });
        }),
      ...
      var d = e.style,
        ...
        B = {
          color: [Q, L],
          background: [Q, L, 'background-color'],
          'outline-color': [Q, L],
          'border-color': [Q, L],
          'border-top-color': [Q, L],
          'border-right-color': [Q, L],
          'border-bottom-color': [Q, L],
          'border-left-color': [Q, L],
          'border-width': [F, P],
    ...
    gs.exports = (function () {
      ...
      var t = {},
        ...
        N =
          ...
          e.forEach =
            function (I, x, M) {
              if (I == null) return I;
              if (h && I.forEach === h) I.forEach(x, M);
              else if (I.length === +I.length) {
                for (var G = 0, $ = I.length; G < $; G++)
                  if (x.call(M, I[G], G, I) === t) return;
              } else
                for (var te = e.keys(I), G = 0, $ = te.length; G < $; G++)
                  if (x.call(M, I[te[G]], te[G], I) === t) return;
              return I;
            });
      (e.map = e.collect =
        function (I, x, M) {
      ...
      (e.contains = e.include =
        ...
        (e.debounce = function (I, x, M) {
          var G,
            ...
            j = function () {
              ...
              U < x
                ? (G = setTimeout(j, x - U))
                : ((G = null), M || ((H = I.apply(te, $)), (te = $ = null)));
            };
          return function () {
            (te = this), ($ = arguments), (q = e.now());
            var U = M && !G;
            return (
              G || (G = setTimeout(j, x)),
        ...
        (e.keys = function (I) {
          ...
          if (L) return L(I);
          var x = [];
          for (var M in I) e.has(I, M) && x.push(M);
          return x;
        }),
        (e.has = function (I, x) {
          return f.call(I, x);
      ...
      var k = /(.)^/,
        ...
        D = /^\s*(\w|\$)+\s*$/;
      return (
        (e.template = function (I, x, M) {
          !x && M && (x = M), (x = e.defaults({}, x, e.templateSettings));
          var G = RegExp(
              [
                (x.escape || k).source,
            ...
            $ = 0,
            te = "__p+='";
          I.replace(G, function (U, F, Q, ue, ce) {
            return (
              (te += I.slice($, ce).replace(ae, ee)),
              ($ = ce + U.length),
              F
                ? (te +=
                    `'+
...
` +
  ...
  var Ye = s((BW, As) => {
    ...
    var un = navigator.userAgent.toLowerCase(),
      ...
      LI = (ve.env.ios = /(ipod|iphone|ipad)/.test(un));
    ve.env.safari = /safari/.test(un) && !PI && !LI;
    var Di;
    Os &&
      NI.on('touchstart mousedown', function (e) {
        Di = e.target;
      });
    ve.validClick = Os
      ? function (e) {
          return e === Di || yt.contains(e, Di);
        }
      : function () {
          return !0;
        };
    ...
    ve.ready = function () {
      (cn = !0), Fi ? MI() : Ke.each(kt, ys), Ke.each(Mi, ys), ve.resize.up();
    };
    function ys(e) {
      nt(e) && e();
    }
    ...
    ln.define(
      ...
      (ws.exports = function (e) {
        ...
        function T(D, I) {
          ...
          switch (I) {
            case 'add':
              (x = D.attr('tabindex')),
                x
                  ? D.attr('data-wf-tabindex-swap', x)
                  : D.attr('tabindex', '-1');
              break;
            case 'remove':
              (x = D.attr('data-wf-tabindex-swap')),
                x
                  ? (D.attr('tabindex', x),
        ...
        function N(D, I) {
          ...
          if (x !== M) {
            var G = k(D, x, M),
              ...
              te = function () {
                var q = Date.now() - $;
                window.scroll(0, Y(x, M, q, G)),
                  q <= G ? u(te) : typeof I == 'function' && I();
              };
            u(te);
          }
        }
        ...
        function k(D, I, x) {
          ...
          var M = 1;
          return (
            a.add(D).each(function (G, $) {
              var te = parseFloat($.getAttribute('data-scroll-time'));
              !isNaN(te) && te >= 0 && (M = te);
            }),
            (472.143 * Math.log(Math.abs(I - x) + 125) - 2e3) * M
          );
        }
        function Y(D, I, x, M) {
          return x > M ? I : D + (I - D) * ae(x / M);
        }
        function ae(D) {
          return D < 0.5
            ? 4 * D * D * D
      ...
      (Cs.exports = function (e) {
        ...
        function n(i) {
          ...
          function v(C) {
            ...
            (A && A.length > 1) ||
              ((a = !0),
              A ? ((u = !0), (f = A[0].clientX)) : (f = C.clientX),
              (h = f));
          }
          function E(C) {
            if (a) {
              ...
              var A = C.touches,
                w = A ? A[0].clientX : C.clientX,
                T = w - h;
              (h = w),
                Math.abs(T) > c &&
                  r &&
                  String(r()) === '' &&
                  (o('swipe', C, { direction: T > 0 ? 'right' : 'left' }), R());
            }
          }
          function y(C) {
  ...
  var Ls = s((KW, Ps) => {
    ...
    Kt.define(
      ...
      (Ps.exports = function (e, t) {
        ...
        function y() {
          (o = i && Kt.env('design')),
            (E = Kt.env('slug') || a.pathname || ''),
            Kt.scroll.off(S),
            (v = []);
          for (var A = document.links, w = 0; w < A.length; ++w) R(A[w]);
          v.length && (Kt.scroll.on(S), S());
        }
        function R(A) {
          var w =
          ...
          if (((u.href = w), !(w.indexOf(':') >= 0))) {
            ...
            if (
              ...
              var L = e(u.hash);
              L.length && v.push({ link: T, sec: L, active: !1 });
              return;
            }
            if (!(w === '#' || w === '')) {
              var P = u.href === a.href || w === E || (f.test(w) && h.test(E));
              C(T, c, P);
            }
          }
        }
        function S() {
          ...
          t.each(v, function (T) {
            var L = T.link,
              ...
              X = P.outerHeight(),
              k = w * 0.5,
              Y = P.is(':visible') && N + X - k >= A && N + k <= A + w;
            T.active !== Y && ((T.active = Y), C(L, c, Y));
          });
        }
        function C(A, w, T) {
          var L = A.hasClass(w);
          (T && L) || (!T && !L) || (T ? A.addClass(w) : A.removeClass(w));
        }
        return r;
      })
    );
  ...
  var Us = s((YW, Xs) => {
    ...
    var Xi = window.jQuery,
      ...
      dn = {
        ...
        intro: function (e, t) {
          t.__wf_intro ||
            ((t.__wf_intro = !0), Xi(t).triggerHandler(it.types.INTRO));
        },
        outro: function (e, t) {
          t.__wf_intro &&
            ((t.__wf_intro = null), Xi(t).triggerHandler(it.types.OUTRO));
        },
      };
    it.triggers = {};
  ...
  var Vi = s(($W, Bs) => {
    ...
    var XI = window.jQuery,
      ...
      UI = {
        ...
        intro: function (e, t) {
          Ui.triggers.intro(e, t), Vs(t, 'COMPONENT_ACTIVE');
        },
        outro: function (e, t) {
          Ui.triggers.outro(e, t), Vs(t, 'COMPONENT_INACTIVE');
        },
      };
    pn.triggers = {};
    pn.types = { INTRO: 'w-ix-intro' + Ws, OUTRO: 'w-ix-outro' + Ws };
    XI.extend(pn.triggers, UI);
    Bs.exports = pn;
  });
  var js = s((QW, Hs) => {
    var VI = Ye();
    ...
    ks.define(
      ...
      (Ks.exports = function (e) {
        ...
        t.ready = function () {
          ...
          /\.webflow\.io$/i.test(R) && a.hostname !== R && (y = !0),
            y &&
              !u &&
              ((f = f || v()),
              E(),
        ...
        function v() {
          ...
          return y.append(R, S), y[0];
        }
        function E() {
          var y = o.children(i),
            R = y.length && y.get(0) === f,
            S = ks.env('editor');
          if (R) {
            S && y.remove();
            return;
          }
          y.length && y.remove(), S || o.append(f);
        }
        return t;
      })
    );
      ...
      (Ys.exports = function (e, t) {
        ...
        function Y(d, V) {
          ...
          _e &&
            ...
            I(B),
            f
              ? (ee(B), B.el.on('setting' + y, x(B)))
              : (D(B),
                B.button.on('click' + y, q(B)),
                B.menu.on('click' + y, 'a', H(B)),
                B.button.on('keydown' + y, M(B)),
                B.el.on('keydown' + y, G(B))),
            F(d, V);
        }
        function ae(d, V) {
          var K = e.data(V, y);
          K && (ee(K), e.removeData(V, y));
        }
        function ee(d) {
        ...
        function M(d) {
          return function (V) {
            switch (V.keyCode) {
              case Ce.SPACE:
              case Ce.ENTER:
                return q(d)(), V.preventDefault(), V.stopPropagation();
              case Ce.ESCAPE:
        ...
        function j(d) {
          return (
            ...
            function (V) {
              var K = e(V.target);
              (h && K.closest('.w-editor-bem-EditorOverlay').length) || U(d, K);
            }
          );
        }
        ...
        function Ee(d, V) {
          ...
          var m = l + Nt;
          n(d.menu).add(_).set({ y: -m }).start({ y: 0 }).then(g);
          function g() {
        ...
        function de(d, V) {
          ...
          var l = vt + _e;
          n(d.menu).add(B).start({ y: -l }).then(p);
          function p() {
            d.menu.height(''),
              ...
              d.dropdownToggle.removeClass(C),
  ...
  var zt = s((tB, Or) => {
    ...
    function HI(e, t) {
      ...
      if (e === null || (BI(e) !== 'object' && typeof e != 'function'))
        return { default: e };
      var r = Zs(t);
  ...
  var vu = s((fB, pu) => {
    var QI = Ie(),
      ...
      ki = QI.Object,
      tm = ZI(''.split);
    pu.exports = JI(function () {
      return !ki('z').propertyIsEnumerable(0);
    })
      ? function (e) {
          return em(e) == 'String' ? tm(e, '') : ki(e);
        }
      : ki;
  });
  var Ki = s((dB, Eu) => {
  ...
  var wr = s((hB, yu) => {
    ...
    yu.exports = function (e, t) {
      return arguments.length < 2 ? um(zi[e]) : zi[e] && zi[e][t];
    };
  });
  var mu = s((gB, Iu) => {
    var cm = $e();
    Iu.exports = cm({}.isPrototypeOf);
  });
  var Ou = s((_B, Tu) => {
    var lm = wr();
    Tu.exports = lm('navigator', 'userAgent') || '';
  });
  var Nu = s((yB, Cu) => {
    var Ru = Ie(),
      Yi = Ou(),
  ...
  var Qi = s((mB, Pu) => {
    var dm = $i();
    Pu.exports = dm && !Symbol.sham && typeof Symbol.iterator == 'symbol';
  });
  var Zi = s((TB, Lu) => {
    var pm = Ie(),
      vm = wr(),
    ...
    Lu.exports = gm
      ...
      : function (e) {
          var t = vm('Symbol');
          return Em(t) && hm(t.prototype, _m(e));
        };
  });
  var Mu = s((OB, Du) => {
    var ym = Ie(),
  ...
  var gn = s((RB, ku) => {
    ...
    ku.exports = function (e, t) {
      try {
        Rm(ju, e, { value: t, configurable: !0, writable: !0 });
      } catch {
        ju[e] = t;
      }
      return t;
  ...
  var no = s((PB, ec) => {
    ...
    ec.exports = function (e) {
      return 'Symbol(' + (e === void 0 ? '' : e) + ')_' + Wm(++Um + Vm, 36);
    };
  });
  var io = s((LB, oc) => {
    var Bm = Ie(),
      ...
      Pt = Bm.Symbol,
      nc = Pt && Pt.for,
      km = ic ? Pt : (Pt && Pt.withoutSetter) || jm;
  ...
  var cc = s((DB, uc) => {
    ...
    uc.exports = function (e, t) {
      ...
      if (r) {
        if (
          (t === void 0 && (t = 'default'), (n = zm(r, e, t)), !ac(n) || sc(n))
        )
          return n;
        throw Zm("Can't convert object to primitive value");
      }
      return t === void 0 && (t = 'number'), $m(e, t);
    };
  });
  var oo = s((MB, lc) => {
    var eT = cc(),
  ...
  var co = s(Ec => {
    ...
    Ec.f = sT
      ...
      : function (t, r) {
          ...
          if (pT(t, r)) return lT(!uT(cT.f, t, r), t[r]);
        };
  });
  var Rr = s((UB, gc) => {
    var hc = Ie(),
  ...
  var fo = s((BB, Tc) => {
    var AT = $e(),
      wT = at(),
      lo = _n(),
      RT = AT(Function.toString);
    wT(lo.inspectSource) ||
      (lo.inspectSource = function (e) {
        return RT(e);
      });
    Tc.exports = lo.inspectSource;
  });
  var Sc = s((HB, bc) => {
    var CT = Ie(),
      NT = at(),
      qT = fo(),
      Oc = CT.WeakMap;
    bc.exports = NT(Oc) && /native code/.test(qT(Oc));
  });
  var po = s((jB, wc) => {
    var xT = ro(),
      PT = no(),
  ...
  var Lc = s((KB, Pc) => {
    var LT = Sc(),
      ...
      VT = function (e) {
        return function (t) {
          var r;
          if (!DT(t) || (r = Nr(t)).type !== e)
            throw _o('Incompatible receiver, ' + e + ' required');
          return r;
        };
      };
    LT || ho.state
      ? ((Tt = ho.state || (ho.state = new XT())),
        (Nc = vo(Tt.get)),
        (go = vo(Tt.has)),
        (qc = vo(Tt.set)),
        (mn = function (e, t) {
          if (go(Tt, e)) throw new _o(Cc);
          return (t.facade = e), qc(Tt, e, t), t;
        }),
        (Nr = function (e) {
          return Nc(Tt, e) || {};
        }),
      ...
      : ((Lt = FT('state')),
        (GT[Lt] = !0),
        (mn = function (e, t) {
          if (Eo(e, Lt)) throw new _o(Cc);
          return (t.facade = e), MT(e, Lt, t), t;
        }),
        (Nr = function (e) {
          return Eo(e, Lt) ? e[Lt] : {};
        }),
    ...
    var Tt, Nc, go, qc, Lt;
    Pc.exports = { set: mn, get: Nr, has: Tn, enforce: UT, getterFor: VT };
  });
  var Fc = s((zB, Mc) => {
    var yo = xt(),
      WT = mt(),
      Dc = Function.prototype,
      BT = yo && Object.getOwnPropertyDescriptor,
      Io = WT(Dc, 'name'),
      HT = Io && function () {}.name === 'something',
      jT = Io && (!yo || (yo && BT(Dc, 'name').configurable));
    Mc.exports = { EXISTS: Io, PROPER: HT, CONFIGURABLE: jT };
  });
  var Wc = s((YB, Vc) => {
    var kT = Ie(),
      Gc = at(),
    ...
    (Vc.exports = function (e, t, r, n) {
      ...
      if (
        (Gc(r) &&
          ...
          (!KT(r, 'name') || ($T && r.name !== u)) && Xc(r, 'name', u),
          (c = ZT(r)),
          c.source || (c.source = JT.join(typeof u == 'string' ? u : ''))),
        e === kT)
      ) {
        i ? (e[t] = r) : zT(t, r);
        return;
      ...
      return (Gc(this) && QT(this).source) || YT(this);
    });
  });
  var mo = s(($B, Bc) => {
    var eO = Math.ceil,
  ...
  var bo = s((tH, Jc) => {
    ...
    Jc.exports = function (e, t) {
      var r = dO(e),
        ...
        o = [],
        i;
      for (i in r) !Oo(vO, i) && Oo(r, i) && Zc(o, i);
      for (; t.length > n; ) Oo(r, (i = t[n++])) && (~pO(o, i) || Zc(o, i));
      return o;
    };
  });
  var On = s((rH, el) => {
  ...
  var ul = s((aH, sl) => {
    ...
    sl.exports = function (e, t) {
      for (var r = SO(t), n = wO.f, o = AO.f, i = 0; i < r.length; i++) {
        var a = r[i];
        bO(e, a) || n(e, a, o(t, a));
      }
    };
  ...
  var ll = s((sH, cl) => {
    var RO = Yt(),
      ...
      qr = function (e, t) {
        var r = xO[qO(e)];
        return r == LO ? !0 : r == PO ? !1 : CO(t) ? RO(t) : !!t;
      },
      qO = (qr.normalize = function (e) {
    ...
    fl.exports = function (e, t) {
      ...
      if (
        ...
        for (u in t) {
          if (
            ((f = t[u]),
            e.noTargetGet ? ((h = DO(a, u)), (c = h && h.value)) : (c = a[u]),
            (i = UO(n ? u : r + (o ? '.' : '#') + u, e.forced)),
            !i && c !== void 0)
          ) {
  ...
  var _l = s((fH, gl) => {
    var zO = wr();
    gl.exports = zO('document', 'documentElement');
  });
  var Al = s((dH, Sl) => {
    var YO = Rr(),
      $O = hl(),
        ...
        Sn =
          typeof document < 'u'
            ? document.domain && bn
              ...
              : tb()
            : Tl(bn);
        for (var e = yl.length; e--; ) delete Sn[wo][yl[e]];
        return Sn();
      };
    QO[Ol] = !0;
    Sl.exports =
      ...
      function (t, r) {
        ...
        return (
          t !== null
            ? ((Ao[wo] = YO(t)), (n = new Ao()), (Ao[wo] = null), (n[Ol] = t))
            : (n = Sn()),
          r === void 0 ? n : $O(n, r)
        );
      };
  ...
  var Rl = s((pH, wl) => {
    var rb = io(),
      ...
      Co = rb('unscopables'),
      No = Array.prototype;
    No[Co] == null && ib.f(No, Co, { configurable: !0, value: nb(null) });
  ...
  var rf = s((wH, tf) => {
    var qb = ef(),
      xb = qb(Object.getPrototypeOf, Object);
    tf.exports = xb;
  });
  var of = s((RH, nf) => {
    function Pb(e) {
  ...
  var xo = s((CH, sf) => {
    var Lb = Zl(),
      ...
      Xb = Object.prototype,
      af = Gb.toString,
      Ub = Xb.hasOwnProperty,
      Vb = af.call(Object);
    function Wb(e) {
      if (!Mb(e) || Lb(e) != Fb) return !1;
      var t = Db(e);
      if (t === null) return !0;
      var r = Ub.call(t, 'constructor') && t.constructor;
      return typeof r == 'function' && r instanceof r && af.call(r) == Vb;
    }
    sf.exports = Wb;
  });
  var uf = s(Po => {
  ...
  var Mo = s(Pr => {
    ...
    var ff = (Pr.ActionTypes = { INIT: '@@redux/INIT' });
    function pf(e, t, r) {
      var n;
      if (
      ...
      function E(S) {
        ...
        for (var C = (a = u), A = 0; A < C.length; A++) C[A]();
        return S;
      }
      function y(S) {
        if (typeof S != 'function')
      ...
      return (
        E({ type: ff.INIT }),
        (n = { dispatch: E, subscribe: v, getState: h, replaceReducer: y }),
        (n[lf.default] = R),
        n
      );
    }
  ...
  var hf = s(Xo => {
    ...
    function rS(e) {
      ...
      return function () {
        ...
        if (u) throw u;
        if (!1) var v;
        for (var E = !1, y = {}, R = 0; R < i.length; R++) {
          var S = i[R],
            C = r[S],
            A = f[S],
            w = C(A, h);
      ...
      return function (n) {
        return function (o, i, a) {
          ...
          return (
            ...
            (c = sS.default.apply(void 0, f)(u.dispatch)),
            oS({}, u, { dispatch: c })
          );
        };
      };
  ...
  var Ho = s(Be => {
    ...
    Be.createStore = fS.default;
    Be.combineReducers = pS.default;
    Be.bindActionCreators = ES.default;
    Be.applyMiddleware = gS.default;
    Be.compose = yS.default;
  });
  var If = s(Ne => {
    'use strict';
    ...
    Ne.EventTypeConsts = mS;
    var TS = { ELEMENT: 'ELEMENT', CLASS: 'CLASS', PAGE: 'PAGE' };
    Ne.EventAppliesTo = TS;
    var OS = { ELEMENT: 'ELEMENT', VIEWPORT: 'VIEWPORT' };
    Ne.EventBasedOn = OS;
    var bS = { X_AXIS: 'X_AXIS', Y_AXIS: 'Y_AXIS' };
    Ne.EventContinuousMouseAxes = bS;
    var SS = {
      CHILDREN: 'CHILDREN',
      SIBLINGS: 'SIBLINGS',
      IMMEDIATE_CHILDREN: 'IMMEDIATE_CHILDREN',
    };
    Ne.EventLimitAffectedElements = SS;
    var AS = {
    ...
    Ne.QuickEffectDirectionConsts = wS;
  });
  var jo = s(er => {
    'use strict';
    ...
    er.ActionTypeConsts = RS;
    var CS = {
      ELEMENT: 'ELEMENT',
      ELEMENT_CLASS: 'ELEMENT_CLASS',
      TRIGGER_ELEMENT: 'TRIGGER_ELEMENT',
    };
    er.ActionAppliesTo = CS;
  });
  var mf = s(An => {
    'use strict';
  ...
  var Of = s(ie => {
    ...
    ie.IX2_VIEWPORT_WIDTH_CHANGED =
      ...
      ie.IX2_ACTION_LIST_PLAYBACK_CHANGED =
        void 0;
    var US = 'IX2_RAW_DATA_IMPORTED';
    ie.IX2_RAW_DATA_IMPORTED = US;
    var VS = 'IX2_SESSION_INITIALIZED';
    ie.IX2_SESSION_INITIALIZED = VS;
    var WS = 'IX2_SESSION_STARTED';
    ie.IX2_SESSION_STARTED = WS;
    var BS = 'IX2_SESSION_STOPPED';
    ie.IX2_SESSION_STOPPED = BS;
    var HS = 'IX2_PREVIEW_REQUESTED';
    ie.IX2_PREVIEW_REQUESTED = HS;
    var jS = 'IX2_PLAYBACK_REQUESTED';
    ie.IX2_PLAYBACK_REQUESTED = jS;
    var kS = 'IX2_STOP_REQUESTED';
    ie.IX2_STOP_REQUESTED = kS;
    var KS = 'IX2_CLEAR_REQUESTED';
    ie.IX2_CLEAR_REQUESTED = KS;
    var zS = 'IX2_EVENT_LISTENER_ADDED';
    ie.IX2_EVENT_LISTENER_ADDED = zS;
    var YS = 'IX2_EVENT_STATE_CHANGED';
    ie.IX2_EVENT_STATE_CHANGED = YS;
    var $S = 'IX2_ANIMATION_FRAME_CHANGED';
    ie.IX2_ANIMATION_FRAME_CHANGED = $S;
    var QS = 'IX2_PARAMETER_CHANGED';
    ie.IX2_PARAMETER_CHANGED = QS;
    var ZS = 'IX2_INSTANCE_ADDED';
    ie.IX2_INSTANCE_ADDED = ZS;
    var JS = 'IX2_INSTANCE_STARTED';
    ie.IX2_INSTANCE_STARTED = JS;
    var eA = 'IX2_INSTANCE_REMOVED';
    ie.IX2_INSTANCE_REMOVED = eA;
    var tA = 'IX2_ELEMENT_STATE_CHANGED';
    ie.IX2_ELEMENT_STATE_CHANGED = tA;
    var rA = 'IX2_ACTION_LIST_PLAYBACK_CHANGED';
    ie.IX2_ACTION_LIST_PLAYBACK_CHANGED = rA;
    var nA = 'IX2_VIEWPORT_WIDTH_CHANGED';
    ie.IX2_VIEWPORT_WIDTH_CHANGED = nA;
    var iA = 'IX2_MEDIA_QUERIES_DEFINED';
    ie.IX2_MEDIA_QUERIES_DEFINED = iA;
    var oA = 'IX2_TEST_FRAME_RENDERED';
    ie.IX2_TEST_FRAME_RENDERED = oA;
  });
  var bf = s(b => {
    'use strict';
    ...
    b.FONT_VARIATION_SETTINGS = MA;
    var FA = 'width';
    b.WIDTH = FA;
    var GA = 'height';
    b.HEIGHT = GA;
    var XA = 'backgroundColor';
    b.BACKGROUND_COLOR = XA;
    var UA = 'background';
    b.BACKGROUND = UA;
    var VA = 'borderColor';
    b.BORDER_COLOR = VA;
    ...
    b.AUTO = kA;
    var KA = ',';
    b.COMMA_DELIMITER = KA;
    var zA = ':';
    b.COLON_DELIMITER = zA;
    var YA = '|';
    b.BAR_DELIMITER = YA;
    var $A = 'CHILDREN';
    b.CHILDREN = $A;
    var QA = 'IMMEDIATE_CHILDREN';
    b.IMMEDIATE_CHILDREN = QA;
    var ZA = 'SIBLINGS';
    b.SIBLINGS = ZA;
    var JA = 'PARENT';
    b.PARENT = JA;
  ...
  var Ue = s(Ae => {
    ...
    var u0 = Sf(Of());
    Ae.IX2EngineActionTypes = u0;
    var c0 = Sf(bf());
    Ae.IX2EngineConstants = c0;
  });
  var Af = s(Cn => {
    'use strict';
    ...
    Cn.ixData = void 0;
    var l0 = Ue(),
      { IX2_RAW_DATA_IMPORTED: f0 } = l0.IX2EngineActionTypes,
      d0 = (e = Object.freeze({}), t) => {
        switch (t.type) {
          case f0:
  ...
  var tr = s(Te => {
    ...
    function Nn(e) {
      var t = typeof e > 'u' ? 'undefined' : p0(e);
    ...
    function xn(e, t) {
      if ((!Array.isArray(t) && Rf(wf), e != null)) {
    ...
    function Vf(e, t, r, n, o, i, a) {
      ...
      return (
        h.length
          ? (c = Ve.call.apply(Ve, [null, !1, !1, u, r, n, o, i, a].concat(h)))
    ...
    function Wf(e, t) {
      ...
      if (!n) return e;
      for (var i = {}, a = Qo(e), u = 0; u < a.length; u++) {
        var c = a[u];
  ...
  var jf = s(Dn => {
    ...
    var g0 = h0(Lr()),
      ...
      y0 = tr(),
      {
        ...
        IX2_CLEAR_REQUESTED: O0,
      } = _0.IX2EngineActionTypes,
      b0 = { preview: {}, playback: {}, stop: {}, clear: {} },
  ...
  var md = s((vj, Id) => {
    var _d = nr(),
      yd = Object.prototype,
      Ew = yd.hasOwnProperty,
      hw = yd.toString,
      Fr = _d ? _d.toStringTag : void 0;
    function gw(e) {
      var t = Ew.call(e, Fr),
        r = e[Fr];
      try {
  ...
  var Jo = s((_j, Rd) => {
    ...
    function Pw(e) {
      if (!Rw(e)) return !1;
      var t = ww(e);
      return t == Nw || t == qw || t == Cw || t == xw;
    }
    Rd.exports = Pw;
  });
  var Nd = s((yj, Cd) => {
    var Lw = Ze(),
      Dw = Lw['__core-js_shared__'];
    Cd.exports = Dw;
  });
  var Pd = s((Ij, xd) => {
    var ea = Nd(),
  ...
  var $d = s((Nj, Yd) => {
    ...
    function gR(e) {
      var t = this.__data__;
      return vR ? t[e] !== void 0 : hR.call(t, e);
    }
    Yd.exports = gR;
  });
  var Zd = s((qj, Qd) => {
  ...
  var bp = s((jj, Op) => {
    ...
    Un.prototype.add = Un.prototype.push = aC;
    Un.prototype.has = sC;
    Op.exports = Un;
  });
  var Ap = s((kj, Sp) => {
  ...
  var na = s((zj, Cp) => {
    ...
    function EC(e, t, r, n, o, i) {
      ...
      var v = -1,
        E = !0,
        y = r & vC ? new lC() : void 0;
      for (i.set(e, t), i.set(t, e); ++v < u; ) {
        var R = e[v],
          S = t[v];
        if (n) var C = a ? n(S, R, v, t, e, i) : n(R, S, v, e, t, i);
        if (C !== void 0) {
          if (C) continue;
          E = !1;
          break;
        ...
        if (y) {
          if (
            !fC(t, function (A, w) {
              if (!dC(y, w) && (R === A || o(R, A, r, n, i))) return y.push(w);
            })
          ) {
            E = !1;
            break;
  ...
  var Up = s((Zj, Xp) => {
    ...
    function FC(e, t, r, n, o, i, a) {
      switch (r) {
        ...
        case DC:
          return !(e.byteLength != t.byteLength || !i(new Fp(e), new Fp(t)));
        case AC:
        case wC:
        case NC:
          return IC(+e, +t);
  ...
  var Ur = s((u5, rv) => {
    var ev = Jp(),
      rN = bt(),
      tv = Object.prototype,
      nN = tv.hasOwnProperty,
      iN = tv.propertyIsEnumerable,
      oN = ev(
        (function () {
          return arguments;
        })()
  ...
  var Wn = s((Vr, sr) => {
    var sN = Ze(),
      ...
      ov = sv && typeof sr == 'object' && sr && !sr.nodeType && sr,
      cN = ov && ov.exports === sv,
      av = cN ? sN.Buffer : void 0,
      lN = av ? av.isBuffer : void 0,
      fN = lN || uN;
    sr.exports = fN;
  });
  var Bn = s((l5, uv) => {
  ...
  var fv = s((d5, lv) => {
    ...
    ye[IN] =
      ...
      ye[xN] =
        !1;
    function HN(e) {
      return yN(e) && _N(e.length) && !!ye[gN(e)];
    }
    lv.exports = HN;
  });
  var pv = s((p5, dv) => {
  ...
  var Ev = s((Wr, ur) => {
    var kN = Zo(),
      vv = typeof Wr == 'object' && Wr && !Wr.nodeType && Wr,
      Br = vv && typeof ur == 'object' && ur && !ur.nodeType && ur,
      KN = Br && Br.exports === vv,
      ua = KN && kN.process,
      zN = (function () {
        try {
  ...
  var Kn = s((y5, bv) => {
    var dq = kn(),
      pq = Ov(),
      vq = Object.prototype,
      Eq = vq.hasOwnProperty;
    function hq(e) {
      if (!dq(e)) return pq(e);
      var t = [];
      for (var r in Object(e)) Eq.call(e, r) && r != 'constructor' && t.push(r);
      return t;
    }
    bv.exports = hq;
  });
  var Mt = s((I5, Sv) => {
    var gq = Jo(),
      _q = Hn();
    function yq(e) {
      return e != null && _q(e.length) && !gq(e);
    }
    Sv.exports = yq;
  });
  var Hr = s((m5, Av) => {
  ...
  var qv = s((O5, Nv) => {
    ...
    function qq(e, t, r, n, o, i) {
      ...
      for (var v = c; v--; ) {
        var E = u[v];
        if (!(a ? E in t : Nq.call(t, E))) return !1;
      }
      var y = i.get(e),
        R = i.get(t);
      if (y && R) return y == t && R == e;
      var S = !0;
      i.set(e, t), i.set(t, e);
      for (var C = a; ++v < c; ) {
        E = u[v];
        var A = e[E],
          w = t[E];
        if (n) var T = a ? n(w, A, E, t, e, i) : n(A, w, E, e, t, i);
  ...
  var zn = s((R5, jv) => {
    var da = Pv(),
      ...
      Yq = cr(ha),
      Ft = Hv;
    ((da && Ft(new da(new ArrayBuffer(1))) != Bv) ||
      (pa && Ft(new pa()) != Xv) ||
      (va && Ft(va.resolve()) != Uv) ||
      (Ea && Ft(new Ea()) != Vv) ||
      (ha && Ft(new ha()) != Wv)) &&
  ...
  var Jv = s((C5, Zv) => {
    var ga = ra(),
      ...
      Yn = '[object Object]',
      tx = Object.prototype,
      Qv = tx.hasOwnProperty;
    function rx(e, t, r, n, o, i) {
      var a = Kv(e),
        u = Kv(t),
        c = a ? $v : kv(e),
        f = u ? $v : kv(t);
      (c = c == Yv ? Yn : c), (f = f == Yv ? Yn : f);
      var h = c == Yn,
        v = f == Yn,
        E = c == f;
      if (E && zv(e)) {
      ...
      if (E && !h)
        return (
          i || (i = new ga()),
          a || Jq(e) ? $q(e, t, r, n, o, i) : Qq(e, t, c, r, n, o, i)
        );
      if (!(r & ex)) {
        var y = h && Qv.call(e, '__wrapped__'),
          R = v && Qv.call(t, '__wrapped__');
        if (y || R) {
          var S = y ? e.value() : e,
            C = R ? t.value() : t;
          return i || (i = new ga()), o(S, C, r, n, i);
        }
      }
      return E ? (i || (i = new ga()), Zq(e, t, r, n, o, i)) : !1;
    }
    Zv.exports = rx;
  });
  var _a = s((N5, rE) => {
    ...
    function ux(e, t, r, n) {
      ...
      for (; ++o < i; ) {
        ...
        if (a && u[2]) {
          ...
          if (!(E === void 0 ? ox(h, f, ax | sx, n, v) : E)) return !1;
        }
      }
      return !0;
    }
  ...
  var jr = s((M5, fE) => {
    var yx = Dt(),
      ...
      mx = '[object Symbol]';
    function Tx(e) {
      return typeof e == 'symbol' || (Ix(e) && yx(e) == mx);
    }
    fE.exports = Tx;
  });
  var $n = s((F5, dE) => {
    ...
    function wx(e, t) {
      ...
      return r == 'number' ||
        ...
        bx(e)
        ? !0
        : Ax.test(e) || !Sx.test(e) || (t != null && e in Object(t));
    }
    dE.exports = wx;
  });
  var EE = s((G5, vE) => {
    var pE = Xn(),
      Rx = 'Expected a function';
    function ma(e, t) {
      if (typeof e != 'function' || (t != null && typeof t != 'function'))
        throw new TypeError(Rx);
      var r = function () {
        var n = arguments,
      ...
      return (r.cache = new (ma.Cache || pE)()), r;
    }
    ma.Cache = pE;
    vE.exports = ma;
  });
    ...
    var xx = gE(),
      ...
      Dx = xx(function (e) {
        ...
        return (
          ...
          e.replace(Px, function (r, n, o, i) {
            t.push(o ? i.replace(Lx, '$1') : n || r);
          }),
          t
        );
      });
  ...
  var AE = s((W5, SE) => {
    var mE = nr(),
      ...
      Xx = jr(),
      Ux = 1 / 0,
      TE = mE ? mE.prototype : void 0,
      OE = TE ? TE.toString : void 0;
    function bE(e) {
      if (typeof e == 'string') return e;
      if (Gx(e)) return Fx(e, bE) + '';
      if (Xx(e)) return OE ? OE.call(e) : '';
      var t = e + '';
  ...
  var kr = s((H5, CE) => {
    var Bx = qe(),
      ...
      kx = RE();
    function Kx(e, t) {
      return Bx(e) ? e : Hx(e, t) ? [e] : jx(kx(e));
    }
    CE.exports = Kx;
  });
  var lr = s((j5, NE) => {
  ...
  var Qn = s((k5, qE) => {
    ...
    function Jx(e, t) {
      t = Qx(t, e);
      for (var r = 0, n = t.length; e != null && r < n; ) e = e[Zx(t[r++])];
  ...
  var UE = s((Q5, XE) => {
    ...
    function TP(e, t) {
      return hP(e) && gP(t)
        ...
        : function (r) {
            var n = vP(r, e);
            return n === void 0 && n === t ? EP(r, e) : pP(t, n, IP | mP);
          };
    }
    XE.exports = TP;
  });
  ...
  var JE = s((ak, ZE) => {
    var jP = QE(),
      kP = /^\s+/;
    function KP(e) {
      return e && e.slice(0, jP(e) + 1).replace(kP, '');
    }
    ZE.exports = KP;
  });
  var ei = s((sk, rh) => {
    ...
    function eL(e) {
      ...
      e = zP(e);
      var r = QP.test(e);
      return r || ZP.test(e) ? JP(e.slice(2), r ? 2 : 8) : $P.test(e) ? th : +e;
    }
    rh.exports = eL;
  });
  var oh = s((uk, ih) => {
  ...
  var uh = s((lk, sh) => {
    ...
    function lL(e, t, r) {
      ...
      if (!n) return -1;
      var o = r == null ? 0 : uL(r);
      return o < 0 && (o = cL(n + o, 0)), aL(e, sL(t, 3), o);
    }
    sh.exports = lL;
  });
  var wa = s((fk, ch) => {
  ...
  var ri = s(Me => {
    ...
    Me.TRANSFORM_PREFIXED = dh;
    var lh = dh.split('transform')[0],
      _L = lh ? lh + 'TransformStyle' : 'transformStyle';
    Me.TRANSFORM_STYLE_PREFIXED = _L;
  });
  var Ra = s((pk, gh) => {
    var yL = 4,
      IL = 0.001,
      ...
      Kr = 11,
      ni = 1 / (Kr - 1),
      OL = typeof Float32Array == 'function';
    function ph(e, t) {
      return 1 - 3 * t + 3 * e;
    }
    function vh(e, t) {
    ...
    function ii(e, t, r) {
      return ((ph(t, r) * e + vh(t, r)) * e + Eh(t)) * e;
    }
    function hh(e, t, r) {
      return 3 * ph(t, r) * e * e + 2 * vh(t, r) * e + Eh(t);
    }
    ...
    gh.exports = function (t, r, n, o) {
      if (!(0 <= t && t <= 1 && 0 <= n && n <= 1))
        throw new Error('bezier x values must be in [0, 1] range');
      var i = OL ? new Float32Array(Kr) : new Array(Kr);
      if (t !== r || n !== o)
        for (var a = 0; a < Kr; ++a) i[a] = ii(a * ni, t, n);
      function u(c) {
        for (var f = 0, h = 1, v = Kr - 1; h !== v && i[h] <= c; ++h) f += ni;
        --h;
        var E = (c - i[h]) / (i[h + 1] - i[h]),
          y = f + E * ni,
          R = hh(y, t, n);
        return R >= IL ? SL(c, y, t, n) : R === 0 ? y : bL(c, f, f + ni, t, n);
      }
      return function (f) {
        return t === r && n === o
          ? f
  ...
  var Ca = s(ne => {
    ...
    var oi = AL(Ra()),
      gt = 1.70158,
      wL = (0, oi.default)(0.25, 0.1, 0.25, 1);
    ne.ease = wL;
    var RL = (0, oi.default)(0.42, 0, 1, 1);
    ne.easeIn = RL;
    var CL = (0, oi.default)(0, 0, 0.58, 1);
    ne.easeOut = CL;
    var NL = (0, oi.default)(0.42, 0, 0.58, 1);
    ne.easeInOut = NL;
    function qL(e) {
      return Math.pow(e, 2);
    }
  ...
  var qa = s(zr => {
    ...
    function vD(e, t, r) {
      return t === 0
        ...
        : t === 1
        ? 1
        : Na(r ? (t > 0 ? r(t) : t) : t > 0 && e && _h[e] ? _h[e](t) : t);
    }
  });
  var Th = s(fr => {
    'use strict';
    Object.defineProperty(fr, '__esModule', { value: !0 });
    fr.createElementState = mh;
    fr.ixElements = void 0;
    fr.mergeActionState = xa;
    var ai = tr(),
      Ih = Ue(),
      {
        HTML_ELEMENT: hk,
        ...
        switch (t.type) {
          ...
          case SD: {
            let {
              ...
              c = e;
            return (
              (0, ai.getIn)(c, [r, n]) !== n && (c = mh(c, n, a, r, i)),
              xa(c, r, u, o, i)
            );
          }
          case AD: {
    ...
    function mh(e, t, r, n, o) {
      let i =
        r === ED ? (0, ai.getIn)(o, ['config', 'target', 'objectId']) : null;
  ...
  var Oh = s(xe => {
    ...
    xe.getPluginDuration = xD;
    var PD = e => e || { value: 0 };
    xe.getPluginOrigin = PD;
    var LD = e => ({ value: e.value });
    xe.getPluginDestination = LD;
    var DD = e => {
      let t = window.Webflow.require('lottie').createInstance(e);
      return t.stop(), t.setSubframe(!0), t;
    };
    xe.createPluginInstance = DD;
    var MD = (e, t, r) => {
      if (!e) return;
  ...
  var Pa = s(Re => {
    ...
    var Gt = Oh(),
      ...
      GD = ri(),
      XD = {
        [bh.ActionTypeConsts.PLUGIN_LOTTIE]: {
    ...
    function UD(e) {
      return e === bh.ActionTypeConsts.PLUGIN_LOTTIE;
    }
    var Xt = e => t => {
      ...
      VD = Xt('getConfig');
    Re.getPluginConfig = VD;
    var WD = Xt('getOrigin');
    Re.getPluginOrigin = WD;
    var BD = Xt('getDuration');
    Re.getPluginDuration = BD;
    var HD = Xt('getDestination');
    Re.getPluginDestination = HD;
    var jD = Xt('createInstance');
  ...
  var Wh = s((Nk, Vh) => {
    ...
    function yM(e, t, r) {
      ...
      return (
        r !== void 0 &&
          ((o = hM(r)), (o = r < 0 ? gM(n + o, 0) : _M(o, n - 1))),
        vM(e, EM(t, 3), o, !0)
      );
    }
    Vh.exports = yM;
  ...
  var kh = s(si => {
    ...
    function bM(e, t) {
      ...
      for (let o = 0; o < r.length; o++)
        if (!OM.call(t, r[o]) || !jh(e[r[o]], t[r[o]])) return !1;
      return !0;
    }
    var SM = bM;
    si.default = SM;
  ...
  var pg = s(ge => {
    ...
    ge.cleanupHTMLElement = TF;
    ge.clearAllStyles = mF;
    ge.getActionListProgress = bF;
    ge.getAffectedElements = Va;
    ge.getComputedStyle = $M;
    ge.getDestinationValues = nF;
    ge.getElementId = kM;
    ge.getInstanceId = HM;
    ge.getInstanceOrigin = JM;
    ge.getItemConfigByKey = void 0;
    ge.getMaxDurationItemIndex = dg;
    ge.getNamespacedParameterId = wF;
    ge.getRenderType = cg;
    ge.getStyleProp = iF;
    ge.mediaQueriesEqual = CF;
    ge.observeStore = YM;
    ge.reduceListToGroup = SF;
    ge.reifyState = KM;
    ge.renderHTMLElement = oF;
    ...
    ge.shouldAllowMediaQuery = RF;
    ge.shouldNamespaceEventParameter = AF;
    ge.stringifyTarget = NF;
    var At = li(Ah()),
      Fa = li(Uh()),
      Ma = li(Hh()),
      Kh = tr(),
      ...
      WM = 'OBJECT_VALUE',
      sg = e => e.trim(),
      Ua = Object.freeze({ [gr]: ng, [_r]: FM, [yr]: GM }),
      ug = Object.freeze({
        [Fe.TRANSFORM_PREFIXED]: RM,
        [ng]: wM,
        [ui]: ui,
        [Yr]: Yr,
        [ct]: ct,
    ...
    var zM = (e, t) => e === t;
    function YM({ store: e, select: t, onChange: r, comparator: n = zM }) {
    ...
    function Va({
      ...
      if (T) return [Qh[T] || (Qh[T] = {})];
      if (N === Ut.EventAppliesTo.PAGE) {
        let M = f(w);
        return M ? [M] : [];
      }
      let Y =
      ...
      if (
        (ae
          ? ((ee = Y.limitAffectedElements), (D = x), (I = h(Y)))
          : (D = I = h({ id: w, selector: L, selectorGuids: P })),
        t && X)
      ) {
        let M = r && (I || X === !0) ? [r] : v(x);
        if (I) {
          if (X === UM) return v(I).filter(G => M.some($ => S(G, $)));
          if (X === zh) return v(I).filter(G => M.some($ => S($, G)));
          if (X === Yh) return v(I).filter(G => M.some($ => C($, G)));
        }
        return M;
      }
    ...
    function $M({ element: e, actionItem: t }) {
    ...
    var Jh = /px/,
      QM = (e, t) =>
        t.reduce(
          (r, n) => (r[n.type] == null && (r[n.type] = aF[n.type]), r),
          e || {}
        ),
      ZM = (e, t) =>
        t.reduce(
          (r, n) => (
            r[n.type] == null &&
              (r[n.type] = sF[n.type] || n.defaultValue || 0),
            r
          ),
          e || {}
        );
        ...
        case hr: {
          ...
          return (
            n.config.widthUnit === wt
              ...
              : (f = (0, At.default)(parseFloat(u), parseFloat(r.width))),
            n.config.heightUnit === wt
              ? (h = Jh.test(c) ? parseFloat(c) : parseFloat(r.height))
              : (h = (0, At.default)(parseFloat(c), parseFloat(r.height))),
    ...
    var eF = (e, t) => (t && (e[t.type] = t.value || 0), e),
      tF = (e, t) => (t && (e[t.type] = t.value || 0), e),
      rF = (e, t, r) => {
        if ((0, ft.isPluginType)(e)) return (0, ft.getPluginConfig)(e)(r, t);
        switch (e) {
          case Jr: {
            let n = (0, Ma.default)(r.filters, ({ type: o }) => o === t);
            return n ? n.value : 0;
          }
          case en: {
            let n = (0, Ma.default)(r.fontVariations, ({ type: o }) => o === t);
            return n ? n.value : 0;
          }
          default:
            return r[t];
    ...
    function nF({ element: e, actionItem: t, elementApi: r }) {
      ...
      switch (t.actionTypeId) {
        ...
        case hr: {
          ...
          if (a === wt) {
            let h = n(e, ct);
            o(e, ct, ''), (c = i(e, 'offsetWidth')), o(e, ct, h);
          }
          if (u === wt) {
            let h = n(e, lt);
            o(e, lt, ''), (f = i(e, 'offsetHeight')), o(e, lt, h);
          }
    ...
    function cg(e) {
      if (/^TRANSFORM_/.test(e)) return ig;
      if (/^STYLE_/.test(e)) return Xa;
      if (/^GENERAL_/.test(e)) return Ga;
      if (/^PLUGIN_/.test(e)) return og;
    }
    function iF(e, t) {
      return e === Xa ? t.replace('STYLE_', '').toLowerCase() : null;
    }
    function oF(e, t, r, n, o, i, a, u, c) {
      switch (u) {
        case ig:
          return lF(e, t, r, o, a);
        case Xa:
          return yF(e, t, r, o, i, a);
        case Ga:
          return IF(e, o, a);
        case og: {
    ...
    function lF(e, t, r, n, o) {
      let i = cF
          .map(u => {
            ...
            switch (u) {
              case pr:
                return `${CM}(${f}${E}, ${h}${y}, ${v}${R})`;
              case vr:
                return `${NM}(${f}${E}, ${h}${y}, ${v}${R})`;
              case Er:
                return `${qM}(${f}${E}) ${xM}(${h}${y}) ${PM}(${v}${R})`;
              case Zr:
                return `${LM}(${f}${E}, ${h}${y})`;
              default:
                return '';
      ...
      Vt(e, Fe.TRANSFORM_PREFIXED, o),
        ...
        pF(n, r) && a(e, Fe.TRANSFORM_STYLE_PREFIXED, DM);
    }
    function fF(e, t, r, n) {
      let o = (0, Fa.default)(t, (a, u, c) => `${a} ${c}(${u}${uF(c, r)})`, ''),
        { setStyle: i } = n;
      Vt(e, Yr, n), i(e, Yr, o);
    }
    function dF(e, t, r, n) {
    ...
    function yF(e, t, r, n, o, i) {
      ...
      switch (n.actionTypeId) {
        case hr: {
          ...
          f !== void 0 &&
            (u === wt && (u = 'px'), Vt(e, ct, i), a(e, ct, f + u)),
            h !== void 0 &&
              (c === wt && (c = 'px'), Vt(e, lt, i), a(e, lt, h + c));
          break;
        }
        case Jr: {
          fF(e, r, n.config, i);
    ...
    function IF(e, t, r) {
      ...
      switch (t.actionTypeId) {
        case fi: {
          ...
          o === MM && Fe.IS_BROWSER_ENV
            ? n(e, ci, Fe.FLEX_PREFIXED)
            : n(e, ci, o);
          return;
        }
      }
    ...
    function Vt(e, t, r) {
      ...
      let u = a.split(Qr).map(sg);
      u.indexOf(n) === -1 && i(e, dr, u.concat(n).join(Qr));
    }
    function lg(e, t, r) {
      if (!Fe.IS_BROWSER_ENV) return;
      let n = ug[t];
    ...
    function mF({ store: e, elementApi: t }) {
      ...
      Object.keys(n).forEach(i => {
        let a = n[i],
          ...
          { actionListId: c } = u,
          f = o[c];
        f && eg({ actionList: f, event: a, elementApi: t });
      }),
        Object.keys(o).forEach(i => {
          eg({ actionList: o[i], elementApi: t });
        });
    }
    function eg({ actionList: e = {}, event: t, elementApi: r }) {
      let { actionItemGroups: n, continuousParameterGroups: o } = e;
      n &&
        n.forEach(i => {
          tg({ actionGroup: i, event: t, elementApi: r });
        }),
        o &&
          o.forEach(i => {
            let { continuousActionGroups: a } = i;
            a.forEach(u => {
              tg({ actionGroup: u, event: t, elementApi: r });
            });
          });
    }
    function tg({ actionGroup: e, event: t, elementApi: r }) {
      let { actionItems: n } = e;
      n.forEach(({ actionTypeId: o, config: i }) => {
        let a;
        (0, ft.isPluginType)(o)
          ? (a = (0, ft.clearPlugin)(o))
          : (a = fg({ effect: OF, actionTypeId: o, elementApi: r })),
          Va({ config: i, event: t, elementApi: r }).forEach(a);
      });
    }
    function TF(e, t, r) {
      ...
      o(e, dr) && fg({ effect: lg, actionTypeId: i, elementApi: r })(e);
    }
    var fg =
    ...
    function bF(e, t) {
      ...
      return (
        r.forEach((c, f) => {
          ...
          let { actionItems: h } = c,
            v = h[dg(h)],
            { config: E, actionTypeId: y } = v;
          o.id === v.id && (u = a + i);
          let R = cg(y) === Ga ? 0 : E.duration;
          a += E.delay + R;
        }),
        a > 0 ? (0, AM.optimizeFloat)(u / a) : 0
      );
    }
    function SF({ actionList: e, actionItemId: t, rawData: r }) {
      let { actionItemGroups: n, continuousParameterGroups: o } = e,
        i = [],
        a = u => (
          i.push((0, Kh.mergeIn)(u, ['config'], { delay: 0, duration: 0 })),
          u.id === t
        );
      return (
    ...
    function CF(e, t) {
      return (0, rg.default)(e && e.sort(), t && t.sort());
    }
    function NF(e) {
      if (typeof e == 'string') return e;
  ...
  var Wt = s(Ge => {
    ...
    Ge.IX2VanillaUtils =
      ...
      Ge.IX2BrowserSupport =
        void 0;
    var qF = Ir(ri());
    Ge.IX2BrowserSupport = qF;
    var xF = Ir(Ca());
    Ge.IX2Easings = xF;
    var PF = Ir(qa());
    Ge.IX2EasingUtils = PF;
    var LF = Ir(Th());
    Ge.IX2ElementsReducer = LF;
    var DF = Ir(Pa());
    Ge.IX2VanillaPlugins = DF;
    var MF = Ir(pg());
    Ge.IX2VanillaUtils = MF;
  });
  var gg = s(pi => {
    'use strict';
    ...
    var vg = Ue(),
      ...
      { RENDER_GENERAL: HF } = vg.IX2EngineConstants,
      {
      ...
      KF = (e, t) => {
        ...
        for (let k = 0, { length: Y } = o; k < Y; k++) {
          let { keyframe: ae, actionItems: ee } = o[k];
          if ((k === 0 && (T = ee[0]), w >= ae)) {
            T = ee[0];
            let D = o[k + 1],
              I = D && w !== ae;
            (L = I ? D.actionItems[0] : null),
              I && ((P = ae / 100), (N = (D.keyframe - ae) / 100));
          }
        }
        let X = {};
        if (T && !L)
          for (let k = 0, { length: Y } = i; k < Y; k++) {
            let ae = i[k];
            X[ae] = Ba(c, ae, T.config);
          }
        else if (T && L && P !== void 0 && N !== void 0) {
          let k = (A - P) / N,
            Y = T.config.easing,
            ae = hg(Y, k, f);
          for (let ee = 0, { length: D } = i; ee < D; ee++) {
            let I = i[ee],
              x = Ba(c, I, T.config),
              $ = (Ba(c, I, L.config) - x) * ae + x;
            X[I] = $;
          }
        }
        return (0, mr.merge)(e, { position: A, current: X });
      },
      zF = (e, t) => {
        let {
            active: r,
        ...
        if (r && n) {
          ...
          if (u) {
            let k = w - o,
              Y = C + A,
              ae = di(Math.min(Math.max(0, k / Y), 1));
            e = (0, mr.set)(e, 'verboseTimeElapsed', Y * ae);
          }
          if (T < 0) return e;
          let L = di(Math.min(Math.max(0, T / C), 1)),
            P = hg(S, L, y),
            N = {},
            X = null;
          return (
        ...
        switch (t.type) {
          ...
          case XF: {
            let {
              ...
              ae = jF(Y),
              ee = kF(ae, Y),
              D = Object.keys(E).filter(x => E[x] != null),
              { easing: I } = o.config;
            return (0, mr.set)(e, r, {
              id: r,
              elementId: n,
              ...
              skipToValue: k,
              customEasingFn:
                Array.isArray(I) && I.length === 4 ? BF(I) : void 0,
            });
          }
          case UF: {
  ...
  var yg = s(Ei => {
    ...
    var t1 = Ho(),
      ...
      a1 = gg(),
      s1 = _g(),
      { ixElements: u1 } = o1.IX2ElementsReducer,
      c1 = (0, t1.combineReducers)({
        ixData: r1.ixData,
        ixRequest: n1.ixRequest,
  ...
  var Tg = s((Xk, mg) => {
    var f1 = Dt(),
      ...
      v1 = '[object String]';
    function E1(e) {
      return typeof e == 'string' || (!d1(e) && p1(e) && f1(e) == v1);
    }
    mg.exports = E1;
  });
  var bg = s((Uk, Og) => {
  ...
  var Dg = s((Wk, Lg) => {
    var Rg = '\\ud800-\\udfff',
      ...
      xg = P1 + '?',
      Pg = '[' + q1 + ']?',
      D1 = '(?:' + L1 + '(?:' + [Cg, Ng, qg].join('|') + ')' + Pg + xg + ')*',
      M1 = Pg + xg + D1,
      F1 = '(?:' + [Cg + Ha + '?', Ha, Ng, qg, x1].join('|') + ')',
      wg = RegExp(ja + '(?=' + ja + ')|' + F1 + M1, 'g');
    function G1(e) {
      for (var t = (wg.lastIndex = 0); wg.test(e); ) ++t;
      return t;
    }
    Lg.exports = G1;
  });
  ...
  var Xg = s((Hk, Gg) => {
    ...
    function $1(e) {
      if (e == null) return 0;
      if (j1(e)) return k1(e) ? K1(e) : e.length;
      var t = H1(e);
      return t == z1 || t == Y1 ? e.size : B1(e).length;
    }
    Gg.exports = $1;
  });
  var Vg = s((jk, Ug) => {
  ...
  var ka = s((kk, Wg) => {
    var J1 = Ot(),
      e2 = (function () {
        try {
          var e = J1(Object, 'defineProperty');
          return e({}, '', {}), e;
        } catch {}
      })();
    Wg.exports = e2;
  ...
  var kg = s((zk, jg) => {
    ...
    function a2(e, t, r) {
      var n = e[t];
      (!(o2.call(e, t) && n2(n, r)) || (r === void 0 && !(t in e))) &&
        r2(e, t, r);
    }
    jg.exports = a2;
  });
  ...
  var Jg = s((Qk, Zg) => {
    var h2 = la(),
      g2 = h2(Object.getPrototypeOf, Object);
    Zg.exports = g2;
  });
  var t_ = s((Zk, e_) => {
    var _2 = Vn(),
  ...
  var E_ = s((oK, v_) => {
    ...
    function aG(e) {
      ...
      for (var r in e) if (oG.call(e, r)) return !1;
      return !0;
    }
    v_.exports = aG;
  });
    ...
    function SG(e, t, r) {
      ...
      (t = A_(t) || 0),
        mG(r) &&
          ((h = !!r.leading),
          (v = 'maxWait' in r),
          (i = v ? OG(A_(r.maxWait) || 0, t) : i),
          (E = 'trailing' in r ? !!r.trailing : E));
      function y(N) {
        var X = n,
          k = o;
        return (n = o = void 0), (f = N), (a = e.apply(k, X)), a;
      }
      function R(N) {
        return (f = N), (u = setTimeout(A, t)), h ? y(N) : a;
      }
      function S(N) {
        var X = N - c,
          k = N - f,
      ...
      function w(N) {
        return (u = void 0), E && n ? y(N) : ((n = o = void 0), a);
      }
      function T() {
        u !== void 0 && clearTimeout(u), (f = 0), (n = c = o = u = void 0);
      }
      function L() {
        return u === void 0 ? a : w(za());
      }
      function P() {
        var N = za(),
          X = C(N);
        if (((n = arguments), (o = this), (c = N), X)) {
          if (u === void 0) return R(c);
          if (v) return clearTimeout(u), (u = setTimeout(A, t)), y(c);
        }
        return u === void 0 && (u = setTimeout(A, t)), a;
      }
      return (P.cancel = T), (P.flush = L), P;
    }
    w_.exports = SG;
  });
  var N_ = s((dK, C_) => {
  ...
  var hi = s(oe => {
    ...
    var q_ = NG(Lr()),
      ...
      qG = Wt(),
      {
        ...
        IX2_INSTANCE_ADDED: jG,
        IX2_INSTANCE_STARTED: kG,
        IX2_INSTANCE_REMOVED: KG,
      ...
      { reifyState: ZG } = qG.IX2VanillaUtils,
      JG = e => ({ type: xG, payload: (0, q_.default)({}, ZG(e)) });
    oe.rawDataImported = JG;
    var eX = ({ hasBoundaryNodes: e, reducedMotion: t }) => ({
      type: PG,
      payload: { hasBoundaryNodes: e, reducedMotion: t },
    });
    oe.sessionInitialized = eX;
    var tX = () => ({ type: LG });
    oe.sessionStarted = tX;
    var rX = () => ({ type: DG });
    oe.sessionStopped = rX;
    var nX = ({ rawData: e, defer: t }) => ({
      type: MG,
      payload: { defer: t, rawData: e },
    });
    oe.previewRequested = nX;
    var iX = ({
    ...
    oe.playbackRequested = iX;
    var oX = e => ({ type: GG, payload: { actionListId: e } });
    oe.stopRequested = oX;
    var aX = () => ({ type: XG });
    oe.clearRequested = aX;
    var sX = (e, t) => ({
      type: UG,
      payload: { target: e, listenerParams: t },
    });
    oe.eventListenerAdded = sX;
    var uX = (e = 1) => ({ type: VG, payload: { step: e } });
    oe.testFrameRendered = uX;
    var cX = (e, t) => ({ type: WG, payload: { stateKey: e, newState: t } });
    oe.eventStateChanged = cX;
    var lX = (e, t) => ({ type: BG, payload: { now: e, parameters: t } });
    oe.animationFrameChanged = lX;
    var fX = (e, t) => ({ type: HG, payload: { key: e, value: t } });
    oe.parameterChanged = fX;
    var dX = e => ({ type: jG, payload: (0, q_.default)({}, e) });
    oe.instanceAdded = dX;
    var pX = (e, t) => ({ type: kG, payload: { instanceId: e, time: t } });
    oe.instanceStarted = pX;
    var vX = e => ({ type: KG, payload: { instanceId: e } });
    oe.instanceRemoved = vX;
    var EX = (e, t, r, n) => ({
      type: zG,
      payload: { elementId: e, actionTypeId: t, current: r, actionItem: n },
    });
    oe.elementStateChanged = EX;
    var hX = ({ actionListId: e, isPlaying: t }) => ({
      type: YG,
      payload: { actionListId: e, isPlaying: t },
    });
    oe.actionListPlaybackChanged = hX;
    var gX = ({ width: e, mediaQueries: t }) => ({
      type: $G,
      payload: { width: e, mediaQueries: t },
    });
    oe.viewportWidthChanged = gX;
    var _X = () => ({ type: QG });
    oe.mediaQueriesDefined = _X;
  });
  var D_ = s(Pe => {
    'use strict';
    Object.defineProperty(Pe, '__esModule', { value: !0 });
    Pe.elementContains = NX;
    Pe.getChildElements = xX;
    Pe.getClosestElement = void 0;
    Pe.getProperty = SX;
    Pe.getQuerySelector = wX;
    Pe.getRefType = DX;
    Pe.getSiblingElements = PX;
    Pe.getStyle = bX;
    Pe.getValidDocument = RX;
    Pe.isSiblingNode = qX;
    Pe.matchSelector = AX;
    Pe.queryDocument = CX;
    Pe.setStyle = OX;
    var yX = Wt(),
      IX = Ue(),
      { ELEMENT_MATCHES: Ya } = yX.IX2BrowserSupport,
      {
        IX2_ID_DELIMITER: P_,
        HTML_ELEMENT: mX,
        PLAIN_OBJECT: TX,
  ...
  var B_ = s((_K, W_) => {
    var U_ = nr(),
      VX = Ur(),
      WX = qe(),
      V_ = U_ ? U_.isConcatSpreadable : void 0;
    function BX(e) {
      return WX(e) || VX(e) || !!(V_ && e && e[V_]);
    }
    W_.exports = BX;
  });
  var k_ = s((yK, j_) => {
  ...
  var Za = s((xK, my) => {
    var Iy = yy(),
      gU = Object.prototype,
      _U = gU.hasOwnProperty;
    function yU(e) {
      for (
        var t = e.name + '', r = Iy[t], n = _U.call(Iy, t) ? r.length : 0;
        n--;
  ...
  var Cy = s((MK, Ry) => {
    ...
    function Ti(e) {
      if (qU(e) && !NU(e) && !(e instanceof RU)) {
        if (e instanceof wy) return e;
        if (LU.call(e, '__wrapped__')) return xU(e);
      }
      return new wy(e);
    }
    Ti.prototype = CU.prototype;
    ...
    function zU(e) {
      return UU(function (t) {
        ...
        for (e && t.reverse(); n--; ) {
          ...
          if (o && !a && Ja(i) == 'wrapper') var a = new xy([], !0);
        }
        for (n = a ? n : r; ++n < r; ) {
          i = t[n];
          var u = Ja(i),
            c = u == 'wrapper' ? VU(i) : void 0;
          c &&
          Py(c[0]) &&
          c[1] == (kU | HU | jU | KU) &&
          !c[4].length &&
          c[9] == 1
            ...
            : (a = i.length == 1 && Py(i) ? a[u]() : a.thru(i));
        }
        return function () {
          var f = arguments,
            h = f[0];
          if (a && f.length == 1 && WU(h)) return a.plant(h).value();
  ...
  var oI = s(wi => {
    ...
    var He = Ai(Lr()),
      ...
      { COLON_DELIMITER: Wy } = Bt.IX2EngineConstants,
      { getNamespacedParameterId: By } = nV.IX2VanillaUtils,
      tI = e => t => typeof t == 'object' && e(t) ? !0 : t,
      nn = tI(({ element: e, nativeEvent: t }) => e === t.target),
      SV = tI(({ element: e, nativeEvent: t }) => e.contains(t.target)),
      dt = (0, eV.default)([nn, SV]),
      rI = (e, t) => {
        if (t) {
          let { ixData: r } = e.getState(),
            { events: n } = r,
            o = n[t];
          if (o && !wV[o.eventTypeId]) return o;
        }
        return null;
      },
      AV = ({ store: e, event: t }) => {
        ...
        return (
          f &&
            (0, ts.stopActionGroup)({
              ...
              eventId: c,
              eventTarget: r,
              eventStateKey: c + Wy + n.split(Wy)[1],
              actionListId: (0, tV.default)(f, 'action.config.actionListId'),
            }),
          (0, ts.stopActionGroup)({
            store: e,
            eventId: a,
      ...
      on = { handler: Je(dt, We) },
      nI = (0, He.default)({}, on, { types: [rs, eI].join(' ') }),
      ns = [
      ...
      is = { types: ns },
      wV = { PAGE_START: Jy, PAGE_FINISH: Zy },
      rn = (() => {
      ...
      iI = e => (t, r) => {
        let { type: n } = t.nativeEvent,
          o = [rs, eI].indexOf(n) !== -1 ? n === rs : r.isActive,
          i = (0, He.default)({}, r, { isActive: o });
      ...
      qV = e => (t, r) => {
        let n = (0, He.default)({}, r, { elementVisible: NV(t) });
        return (
      ...
      bi = (e = !0) =>
        (0, He.default)({}, nI, {
          handler: Je(
            e ? dt : nn,
            iI((t, r) => (r.isActive ? on.handler(t, r) : r))
          ),
        }),
      Si = (e = !0) =>
        (0, He.default)({}, nI, {
          handler: Je(
            e ? dt : nn,
            iI((t, r) => (r.isActive ? r : on.handler(t, r)))
          ),
        }),
      zy = (0, He.default)({}, is, {
        handler: qV((e, t) => {
      ...
      DV = {
        ...
        [vV]: bi(),
        [EV]: Si(),
        [OV]: { types: 'ecommerce-cart-open', handler: Je(dt, We) },
        [TV]: { types: 'ecommerce-cart-close', handler: Je(dt, We) },
        [iV]: {
          types: 'click',
          handler: Je(
            dt,
        ...
        [aV]: (0, He.default)({}, on, { types: 'mousedown' }),
        [sV]: (0, He.default)({}, on, { types: 'mouseup' }),
        [uV]: {
          types: Hy,
          handler: Je(
            dt,
          ...
          handler: (
            ...
            switch (a) {
              ...
              case Bt.EventBasedOn.PAGE: {
                ...
                A = S ? Math.min(L + y, N) / N : Math.min(P + R, X) / X;
                break;
              }
              ...
              default: {
                ...
                if (L && dt({ element: t, nativeEvent: n }) !== !0) break;
                let P = t.getBoundingClientRect(),
                  { left: N, top: X, width: k, height: Y } = P;
                if (!L && !xV({ left: v, top: E }, P)) break;
                (T = !0), (A = S ? (v - N) / k : (E - X) / Y);
                break;
              }
            }
            return (
              C && (A > 1 - Yy || A < Yy) && (A = Math.round(A)),
              (a !== Bt.EventBasedOn.ELEMENT || T || T !== i.elementHovered) &&
                ((A = f ? 1 - A : A),
                e.dispatch((0, Oi.parameterChanged)(w, A))),
              { elementHovered: T, clientX: v, clientY: E, pageX: y, pageY: R }
            );
          },
        },
        [bV]: {
        ...
        [mV]: {
          ...
          handler: (
            ...
            if (h === Bt.EventBasedOn.VIEWPORT) {
              ...
              return (
                L !== o.scrollPercent &&
                  t.dispatch((0, Oi.parameterChanged)(E, L)),
                { scrollPercent: L }
              );
            } else {
              let L = By(n, E),
                ...
                X = (S ? w : 0) / 100;
              (N = y ? N : 1 - N), (X = R ? X : 1 - X);
              let k = P.top + Math.min(P.height * N, f),
                ae = P.top + P.height * X - k,
                ee = Math.min(f + ae, c),
                I = Math.min(Math.max(0, f - k), ee) / ee;
              return (
                I !== o.scrollPercent &&
                  t.dispatch((0, Oi.parameterChanged)(L, I)),
                { scrollPercent: I }
              );
            }
          },
  ...
  var os = s(Ct => {
    ...
    Ct.observeRequests = fW;
    Ct.startActionGroup = ds;
    Ct.startEngine = qi;
    Ct.stopActionGroup = fs;
    Ct.stopAllActionGroups = vI;
    Ct.stopEngine = xi;
    var FV = tt(Lr()),
      GV = tt(Ig()),
      XV = tt(wa()),
      ...
      we = MV(D_()),
      jV = tt(oI()),
      kV = ['store', 'computedStyle'],
      KV = Object.keys(et.QuickEffectIds),
      as = e => KV.includes(e),
      {
        COLON_DELIMITER: ss,
      ...
      } = et.IX2EngineConstants,
      {
        ...
        shouldNamespaceEventParameter: rW,
        getNamespacedParameterId: nW,
      ...
      cW = sI.match(/iPad/i) || sI.match(/iPhone/),
      lW = 12;
    function fW(e) {
      Ht({ store: e, select: ({ ixRequest: t }) => t.preview, onChange: vW }),
        Ht({
          store: e,
          select: ({ ixRequest: t }) => t.playback,
          onChange: EW,
        }),
        Ht({ store: e, select: ({ ixRequest: t }) => t.stop, onChange: hW }),
        Ht({ store: e, select: ({ ixRequest: t }) => t.clear, onChange: gW });
    }
    function dW(e) {
      Ht({
        store: e,
    ...
    function vW({ rawData: e, defer: t }, r) {
      let n = () => {
        qi({ store: r, rawData: e, allowEvents: !0 }), fI();
      };
      t ? setTimeout(n, 0) : n();
    }
    function fI() {
    ...
    function EW(e, t) {
      ...
      if (n && o && h && u) {
        ...
        v && (h = tW({ actionList: v, actionItemId: o, rawData: h }));
      }
      if (
        (qi({ store: t, rawData: h, allowEvents: a, testManual: c }),
        (n && r === et.ActionTypeConsts.GENERAL_START_ACTION) || as(r))
      ) {
        fs({ store: t, actionListId: n }),
          pI({ store: t, actionListId: n, eventId: i });
        let v = ds({
          store: t,
          eventId: i,
          actionListId: n,
    ...
    function hW({ actionListId: e }, t) {
      e ? fs({ store: t, actionListId: e }) : vI({ store: t }), xi(t);
    }
    function gW(e, t) {
      xi(t), lI({ store: t, elementApi: we });
    }
    ...
    function _W() {
      ...
      e.className.indexOf(aI) === -1 && (e.className += ` ${aI}`);
    }
    function yW(e, t) {
      let r = n => {
    ...
    function xi(e) {
      ...
      if (t.active) {
        ...
        r.forEach(IW), e.dispatch((0, Oe.sessionStopped)());
      }
    }
    ...
    function mW({
      ...
      let { ixData: f, ixSession: h } = e.getState(),
        ...
        { id: w } = a;
      rW(y, o) && (w = nW(t, w));
      let T = h.hasBoundaryNodes && r ? we.getClosestElement(r, Ri) : null;
      A.forEach(L => {
        ...
        N.forEach(X => {
          let { actionTypeId: k } = X,
            { target: Y } = X.config;
          if (!Y) return;
          let ae = Y.boundaryMode ? T : null,
            ee = oW(Y) + ss + k;
          if (((S[ee] = TW(S[ee], P, X)), !R[ee])) {
            R[ee] = !0;
            let { config: D } = X;
            Ci({
              config: D,
              ...
              C.push({ element: I, key: ee });
            });
          }
        });
      }),
        C.forEach(({ element: L, key: P }) => {
          let N = S[P],
            X = (0, Rt.default)(N, '[0].actionItems[0]', {}),
            { actionTypeId: k } = X,
            Y = cs(k) ? ls(k)(L, X) : null,
            ae = us({ element: L, actionItem: X, elementApi: we }, Y);
          ps({
            store: e,
            element: L,
            eventId: n,
    ...
    var AW = (e, t) => (0, VV.default)((0, BV.default)(e, t), WV.default),
      wW = (e, t) => {
        (0, an.default)(e, (r, n) => {
          r.forEach((o, i) => {
            let a = n + ss + i;
    ...
    function CW({ logic: e, store: t, events: r }) {
      ...
      (0, an.default)(u, (v, E) => {
        let y = r[E],
          { action: R, id: S, mediaQueries: C = i.mediaQueryKeys } = y,
          { actionListId: A } = R.config;
        aW(C, i.mediaQueryKeys) || t.dispatch((0, Oe.mediaQueriesDefined)()),
          R.actionTypeId === et.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION &&
            (Array.isArray(y.config) ? y.config : [y.config]).forEach(T => {
              let { continuousParameterGroupId: L } = T,
                P = (0, Rt.default)(a, `${A}.continuousParameterGroups`, []),
                N = (0, XV.default)(P, ({ id: Y }) => Y === L),
                X = (T.smoothing || 0) / 100,
          ...
          (R.actionTypeId === et.ActionTypeConsts.GENERAL_START_ACTION ||
            as(R.actionTypeId)) &&
            pI({ store: t, actionListId: A, eventId: S });
      });
      let c = v => {
          ...
          wW(u, (y, R, S) => {
            let C = r[R],
              A = E.eventState[S],
              { action: w, mediaQueries: T = i.mediaQueryKeys } = C;
            ...
            let L = (P = {}) => {
              ...
              sW(N, A) || t.dispatch((0, Oe.eventStateChanged)(S, N));
            };
            w.actionTypeId === et.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION
              ? (Array.isArray(C.config) ? C.config : [C.config]).forEach(L)
              : L();
          });
        },
        f = (0, HV.default)(c, lW),
        h = ({ target: v = document, types: E, throttle: y }) => {
          E.split(' ')
            .filter(Boolean)
            .forEach(R => {
              let S = y ? f : c;
              v.addEventListener(R, S),
                t.dispatch((0, Oe.eventListenerAdded)(v, [R, S]));
            });
        };
    ...
    function pI({ store: e, actionListId: t, eventId: r }) {
      ...
      if (c && c.useFirstGroupAsInitialState) {
        let f = (0, Rt.default)(c, 'actionItemGroups[0].actionItems', []),
          h = (0, Rt.default)(u, 'mediaQueries', n.mediaQueryKeys);
        if (!Ni(h, o.mediaQueryKey)) return;
        f.forEach(v => {
          var E;
          let { config: y, actionTypeId: R } = v,
            S =
              (y == null || (E = y.target) === null || E === void 0
                ? void 0
                : E.useEventTarget) === !0
                ? { target: u.target, targets: u.targets }
                : y,
            C = Ci({ config: S, event: u, elementApi: we }),
            A = cs(R);
          C.forEach(w => {
            let T = A ? ls(R)(w, v) : null;
            ps({
              destination: us({ element: w, actionItem: v, elementApi: we }, T),
              immediate: !0,
              store: e,
              element: w,
              eventId: r,
    ...
    function ds({
      ...
      let { ixData: f, ixSession: h } = e.getState(),
        { events: v } = f,
        E = v[t] || {},
        { mediaQueries: y = f.mediaQueryKeys } = E,
        R = (0, Rt.default)(f, `actionLists.${o}`, {}),
        { actionItemGroups: S, useFirstGroupAsInitialState: C } = R;
      if (!S || !S.length) return !1;
      i >= S.length && (0, Rt.default)(E, 'config.loop') && (i = 0),
        i === 0 && C && i++;
      let w =
          (i === 0 || (i === 1 && C)) &&
          as((c = E.action) === null || c === void 0 ? void 0 : c.actionTypeId)
            ? E.config.delay
            : void 0,
        T = (0, Rt.default)(S, [i, 'actionItems'], []);
      if (!T.length || !Ni(y, h.mediaQueryKey)) return !1;
      let L = h.hasBoundaryNodes && r ? we.getClosestElement(r, Ri) : null,
        P = ZV(T),
        N = !1;
      return (
        T.forEach((X, k) => {
          let { config: Y, actionTypeId: ae } = X,
            ee = cs(ae),
            { target: D } = Y;
          if (!D) return;
          let I = D.boundaryMode ? L : null;
          Ci({
            config: Y,
            event: E,
            eventTarget: r,
            ...
            let $ = ee ? ls(ae)(M, X) : null,
              te = ee ? uW(ae)(M, X) : null;
            N = !0;
            let q = P === k && G === 0,
              H = JV({ element: M, actionItem: X }),
              j = us({ element: M, actionItem: X, elementApi: we }, $);
            ps({
              store: e,
              element: M,
              actionItem: X,
    ...
    function ps(e) {
      ...
      let { store: r, computedStyle: n } = e,
        ...
        E = !f,
        y = $V(),
        { ixElements: R, ixSession: S, ixData: C } = r.getState(),
        A = YV(R, i),
        { refState: w } = R[A] || {},
        T = we.getRefType(i),
        L = S.reducedMotion && et.ReducedMotionTypes[a.actionTypeId],
        P;
      if (L && f)
        switch (
          (t = C.events[v]) === null || t === void 0 ? void 0 : t.eventTypeId
        ) {
      ...
      if (
        ...
        EI(document.body, 'ix2-animation-started', y),
        u)
      ) {
        qW(r, y);
        return;
      }
      Ht({ store: r, select: ({ ixInstances: X }) => X[y], onChange: hI }),
        E && r.dispatch((0, Oe.instanceStarted)(y, S.tick));
    }
    function vs(e, t) {
      ...
      let { elementId: r, actionItem: n } = e,
        ...
        { ref: i, refType: a } = o[r] || {};
      a === cI && iW(i, n, we), t.dispatch((0, Oe.instanceRemoved)(e.id));
    }
    function EI(e, t, r) {
    ...
    function hI(e, t) {
      let {
        ...
        { events: P } = T,
        N = P[v] || {},
        { mediaQueries: X = T.mediaQueryKeys } = N;
      if (Ni(X, L.mediaQueryKey) && (n || r || o)) {
        if (f || (c === zV && o)) {
          t.dispatch((0, Oe.elementStateChanged)(i, u, f, a));
          let { ixElements: k } = t.getState(),
            { ref: Y, refType: ae, refState: ee } = k[i] || {},
            D = ee && ee[u];
          switch (ae) {
            case cI: {
              QV(Y, ee, D, v, a, C, we, c, w);
              break;
            }
          }
        }
  ...
  var _I = s(_t => {
    ...
    var LW = Ho(),
      ...
      MW = xW(hi());
    _t.actions = MW;
    var Pi = (0, LW.createStore)(DW.default);
    _t.store = Pi;
    function FW(e) {
      e() && (0, Es.observeRequests)(Pi);
    }
    function GW(e) {
      gI(), (0, Es.startEngine)({ store: Pi, rawData: e, allowEvents: !0 });
    }
    function gI() {
      (0, Es.stopEngine)(Pi);
    }
  ...
  var bI = s((kK, OI) => {
    ...
    hs.define(
      ...
      (OI.exports = function (e, t) {
        ...
        function L() {
          (y = !0),
            n.on('submit', u + ' form', function (ce) {
              var J = e.data(this, u);
          ...
          n.on(
            'change',
            u + ' form input[type="checkbox"]:not(' + q + ')',
            ce => {
              e(ce.target).siblings(q).toggleClass(j);
            }
          ),
            n.on('change', u + ' form input[type="radio"]', ce => {
              e(`input[name="${ce.target.name}"]:not(${q})`).map((Ee, pt) =>
        ...
        function P(q) {
          var H = (q.btn = q.form.find(':input[type="submit"]'));
          (q.wait = q.btn.attr('data-wait') || null),
            (q.success = !1),
            H.prop('disabled', !1),
            q.label && H.val(q.label);
        }
        function N(q) {
          var H = q.btn,
            j = q.wait;
          H.prop('disabled', !0), j && ((q.label = H.val()), H.val(j));
        }
        function X(q, H) {
          var j = null;
          return (
            ...
            q
              ...
              .each(function (U, F) {
                ...
                if (ue === 'checkbox') J = Q.is(':checked');
                  ...
                  J =
                    q
                      .find('input[name="' + Q.attr('name') + '"]:checked')
                      .val() || null;
                }
        ...
        function k(q) {
          var H = {};
          return (
            q.find(':input[type="file"]').each(function (j, U) {
              var F = e(U),
        ...
        function I(q) {
          ...
          t.each(j, function (J, Ee) {
            ...
            F &&
              ...
              (j.FNAME = F[0]),
              (j.LNAME = j.LNAME || F[1]));
          var Q = q.action.replace('/post?', '/post-json?') + '&c=?',
            ue = Q.indexOf('u=') + 2;
          ...
          (ce = Q.substring(ce, Q.indexOf('&', ce))),
            ...
            e
              ...
              .done(function (J) {
                (q.success = J.result === 'success' || /already/.test(J.msg)),
                  q.success || console.info('MailChimp error: ' + J.msg),
                  x(q);
              })
              .fail(function () {
                x(q);
        ...
        function G(q, H) {
          if (!H.fileUploads || !H.fileUploads[q]) return;
          var j,
            U = e(H.fileUploads[q]),
          ...
          if (
            (E ||
              Ee.on('click keydown', function (g) {
                (g.type === 'keydown' && g.which !== 13 && g.which !== 32) ||
                  (g.preventDefault(), J.click());
              }),
            Ee.find('.w-icon-file-upload-icon').attr('aria-hidden', 'true'),
            V.find('.w-icon-file-upload-remove').attr('aria-hidden', 'true'),
            E)
          )
            J.on('click', function (g) {
              g.preventDefault();
            }),
              Ee.on('click', function (g) {
                g.preventDefault();
              }),
              pt.on('click', function (g) {
                g.preventDefault();
              });
          else {
            V.on('click keydown', function (g) {
              if (g.type === 'keydown') {
              ...
              J.on('change', function (g) {
                (j = g.target && g.target.files && g.target.files[0]),
                  j &&
                    (F.toggle(!1),
                    ce.toggle(!1),
                    Q.toggle(!0),
          ...
          function p(g, O) {
            ...
            var z = O.fileName,
              ...
              he = O.fileId,
              W = O.s3Url;
            J.attr('data-value', he), te(W, re, j, z, _);
          }
          function _(g) {
            if (g) return l(g);
            Q.toggle(!1),
        ...
        function $(q, H) {
          var j = new URLSearchParams({ name: q.name, size: q.size });
          e.ajax({ type: 'GET', url: `${S}?${j}`, crossDomain: !0 })
            .done(function (U) {
              H(null, U);
            })
            .fail(function (U) {
...
Webflow.require('ix2').init({
  events: {
    ...
    'e-27': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '641cb5490c212b4392ee909c|fdf44161-618d-3e39-1103-a88ac4d9f3fe',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-29': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '641cb5490c212b4392ee909c|dbc42c68-f790-3e9f-d4fb-7df0e4952e01',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-31': {
      ...
      mediaQueries: ['main'],
      target: {
        id: 'abe74adc-4e99-06d2-2572-c54f43561e6f',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-33': {
      ...
      mediaQueries: ['main'],
      target: {
        id: 'abe74adc-4e99-06d2-2572-c54f43561e73',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-35': {
      ...
      mediaQueries: ['main'],
      target: {
        id: 'abe74adc-4e99-06d2-2572-c54f43561e81',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-37': {
      ...
      action: {
        ...
        actionTypeId: 'SLIDE_EFFECT',
        instant: false,
        config: { actionListId: 'slideInRight', autoStopEventId: 'e-38' },
      },
      mediaQueries: ['main'],
      target: {
        id: 'abe74adc-4e99-06d2-2572-c54f43561e8c',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-39': {
      ...
      mediaQueries: ['main'],
      target: {
        id: 'abe74adc-4e99-06d2-2572-c54f43561e93',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-41': {
      ...
      mediaQueries: ['main'],
      target: {
        id: 'abe74adc-4e99-06d2-2572-c54f43561e97',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-43': {
      ...
      mediaQueries: ['main'],
      target: {
        id: 'abe74adc-4e99-06d2-2572-c54f43561ea5',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-45': {
      ...
      mediaQueries: ['main'],
      target: {
        id: 'abe74adc-4e99-06d2-2572-c54f43561eb0',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-47': {
      ...
      mediaQueries: ['main'],
      target: {
        id: 'abe74adc-4e99-06d2-2572-c54f43561eb7',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-49': {
      ...
      mediaQueries: ['main'],
      target: {
        id: 'abe74adc-4e99-06d2-2572-c54f43561ebb',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-51': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '641cb5490c212b4392ee909c|0a756bd8-7f38-c2f4-5a74-92794388a9e4',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-53': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '641cb5490c212b4392ee909c|8c9ac310-521b-fbd6-3874-5cd55f8c61b0',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-55': {
      ...
      mediaQueries: ['main'],
      target: {
        id: '641cb5490c212b4392ee909c|22b15606-1f64-48e5-435d-f4b0f2e54d6e',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-62': {
      ...
      mediaQueries: ['main'],
      target: {
        id: 'abe74adc-4e99-06d2-2572-c54f43561e6c',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-64': {
      ...
      mediaQueries: ['main'],
      target: {
        id: 'abe74adc-4e99-06d2-2572-c54f43561e90',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-65': {
      ...
      mediaQueries: ['main'],
      target: {
        id: 'abe74adc-4e99-06d2-2572-c54f43561eb4',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-66': {
      ...
      mediaQueries: ['main'],
      target: {
        id: 'abe74adc-4e99-06d2-2572-c54f43561e7e',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-67': {
      ...
      mediaQueries: ['main'],
      target: {
        id: 'abe74adc-4e99-06d2-2572-c54f43561ea2',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-68': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '426b921f-11e9-9a9b-72be-c0e1bd554c9e',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-70': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '642170ff418cab29e706dd74|f65532f2-4f58-69fa-9bc8-420a01bb43fa',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-72': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '642170ff418cab29e706dd74|f65532f2-4f58-69fa-9bc8-420a01bb440f',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-75': {
      ...
      target: {
        ...
        originalId:
          '642170ff418cab29e706dd74|0f99bceb-b0ee-3d71-b4f1-802a24bc6107',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-76': {
      ...
      mediaQueries: ['main'],
      target: {
        id: '642170ff418cab29e706dd74|0f99bceb-b0ee-3d71-b4f1-802a24bc610b',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-78': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '642170ff418cab29e706dd74|6ee4b95e-d630-73a9-40ef-c508c0f2ecec',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-79': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '641cb5490c212b4392ee909c|89f340bc-377a-2602-fa94-1813ebfa15ee',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-81': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '6421710b9382682e6c86855b|4954118a-7fef-c040-a7a5-b6d03249ad09',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-83': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '6421710b9382682e6c86855b|d5fc1cb0-8cf1-e7de-1964-1fe099c2610c',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-93': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '6421710b9382682e6c86855b|b8d455df-9cd3-972c-b847-274c3901004d',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-94': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '6421710b9382682e6c86855b|582a1963-200e-0b5f-54b9-63e17deb9ced',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-95': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '6421710b9382682e6c86855b|c44cf487-e634-2808-1329-6c18615186b3',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-96': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '6421710b9382682e6c86855b|b9ad8cdc-fd24-23ad-cb3b-eb9316857abf',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-97': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '6421710b9382682e6c86855b|05d283f4-e4ec-0d19-f814-77a08cbb9866',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-98': {
      ...
      mediaQueries: ['main'],
      target: {
        id: '641cb5490c212b4392ee909c|3b4b9dee-cbdb-d95c-3d89-345ac4743747',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-99': {
      ...
      mediaQueries: ['main'],
      target: {
        id: '641cb5490c212b4392ee909c|3b4b9dee-cbdb-d95c-3d89-345ac474374a',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-103': {
      ...
      mediaQueries: ['main'],
      target: {
        id: '641cb5490c212b4392ee909c|3b4b9dee-cbdb-d95c-3d89-345ac4743755',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-105': {
      ...
      mediaQueries: ['main'],
      target: {
        id: '3b4b9dee-cbdb-d95c-3d89-345ac4743747',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-106': {
      ...
      mediaQueries: ['main'],
      target: {
        id: '641cb5490c212b4392ee909c|d5694906-9889-09e9-e2a5-5e5fed39db33',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-115': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '641cb5490c212b4392ee909c|3604fe58-18cb-3ba4-1a9e-dd5e8a6796b1',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-120': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '641cb5490c212b4392ee909c|bef7b907-00a4-1866-8648-a52ad943aaf5',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-122': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '641cb5490c212b4392ee909c|27cc43d1-6965-5054-54a0-bf09724ee418',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-124': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '641cb5490c212b4392ee909c|9d5093d5-b31e-4aa2-ef04-540cbb3fcdda',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-126': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '642170ef93826831548684b7|3b8cdf68-2d2e-142d-d1e0-45630486b5a3',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-128': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '642170ef93826831548684b7|3b8cdf68-2d2e-142d-d1e0-45630486b5b8',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-130': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '642170ef93826831548684b7|3b8cdf68-2d2e-142d-d1e0-45630486b5a1',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-131': {
      ...
      target: {
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
        id: '641cb5490c212b4392ee909c|5d0ff658-95dc-91ed-f0be-7460ae2d47cc',
      },
      targets: [],
      config: {
        loop: false,
  ...
  actionLists: {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 20000,
                target: {
                  id: '641cb5490c212b4392ee909c|7eaf741b-5f91-c9a5-1baa-7126ef472e9e',
                },
                zValue: 359,
                xUnit: 'DEG',
                yUnit: 'DEG',
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selector: '.col-left',
                      selectorGuids: ['696daf97-59f8-3d57-ac2b-a77ed0776df1'],
                    },
                    yValue: 0,
                    xUnit: 'PX',
                    yUnit: 'rem',
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.col-right',
                      selectorGuids: ['980ae4ce-bf5b-3a47-a14b-95555312e39b'],
                    },
                    yValue: 0,
                    xUnit: 'PX',
                    yUnit: 'rem',
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.mockup-mobile',
                      selectorGuids: ['dc563fee-44bb-4725-7160-b61887058fd2'],
                    },
                    xValue: -5,
                    xUnit: 'rem',
                    yUnit: 'PX',
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.mockup-laptop',
                      selectorGuids: ['062341cd-a4b4-047a-62c6-d04b7005ce8a'],
                    },
                    yValue: -10,
                    xUnit: 'DEG',
                    yUnit: 'deg',
    ...
    'a-11': {
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.card-item.card-2',
                      selectorGuids: [
                        '0ad7031e-2697-30b7-6ddb-724c29e363f7',
                        '0ad7031e-2697-30b7-6ddb-724c29e363fa',
                      ],
                    },
                    yValue: 200,
                    xUnit: 'PX',
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.card-item.card-3',
                      selectorGuids: [
                        '0ad7031e-2697-30b7-6ddb-724c29e363f7',
                        '0ad7031e-2697-30b7-6ddb-724c29e363fd',
                      ],
                    },
                    yValue: 200,
                    xUnit: 'PX',
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.card-item.card-4',
                      selectorGuids: [
                        '0ad7031e-2697-30b7-6ddb-724c29e363f7',
                        '0ad7031e-2697-30b7-6ddb-724c29e363fe',
                      ],
                    },
                    yValue: 200,
                    xUnit: 'PX',
      ...
      createdOn: 1674418200492,
    },
    'a-12': {
      id: 'a-12',
      title: 'services-hero-scroll',
      continuousParameterGroups: [
        {
          id: 'a-12-p',
          type: 'SCROLL_PROGRESS',
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      id: '642170ff418cab29e706dd74|dee87dad-10a9-1b46-6dc7-4a5555ec08d4',
                    },
                    xValue: 0,
                    yValue: 0,
                    zValue: null,
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      id: '642170ff418cab29e706dd74|3a5a59ff-9c69-bcc7-1e88-a71e8700f29f',
                    },
                    xValue: 0,
                    yValue: 0,
                    xUnit: '%',
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: ['8f75abf6-4f0a-01fc-3804-1b82a4ccc0fc'],
                    },
                    globalSwatchId: '',
                    rValue: 65,
                    bValue: 65,
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: ['8f75abf6-4f0a-01fc-3804-1b82a4ccc103'],
                    },
                    value: 0.25,
                    unit: '',
                  },
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: ['8f75abf6-4f0a-01fc-3804-1b82a4ccc110'],
                    },
                    value: 0.25,
                    unit: '',
                  },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ['7060b9af-8c61-1c1c-be55-0c049f8b3631'],
                },
                heightValue: 0,
                widthUnit: 'PX',
                heightUnit: 'PX',
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: 'CHILDREN',
                  selector: '.plus-icon',
                  selectorGuids: ['7060b9af-8c61-1c1c-be55-0c049f8b362a'],
                },
                zValue: 0,
                xUnit: 'DEG',
                yUnit: 'DEG',
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ['7060b9af-8c61-1c1c-be55-0c049f8b3630'],
                },
                globalSwatchId: '',
                rValue: 140,
                bValue: 255,
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.hero-img-tablet-1',
                      selectorGuids: ['d7c3f37d-f500-be2f-c51a-1cd2381a09b3'],
                    },
                    xValue: 0,
                    yValue: 0,
                    xUnit: '%',
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.hero-img-tablet-2',
                      selectorGuids: ['77967f3b-369d-a185-25cc-b603172c3052'],
                    },
                    xValue: 0,
                    yValue: 0,
                    xUnit: '%',
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.hero-img-tablet-3',
                      selectorGuids: ['df57828b-4434-642e-3c0c-efc49817b9da'],
                    },
                    xValue: 0,
                    yValue: 0,
                    xUnit: '%',
                ...
                },
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: 'CHILDREN',
                      selector: '.hero-img-tablet-4',
                      selectorGuids: ['2f1efacf-f1d0-6a44-fa26-d00751ea9c93'],
                    },
                    xValue: 0,
                    yValue: 0,
                    xUnit: '%',
